...
def main(json_path='options/hfpsr_prototype.json'):
    '''
    # ----------------------------------------
    # Step--1 (prepare opt)
    # ----------------------------------------
        ...
        for i, train_data in enumerate(train_loader):
            ...
            if current_step % opt['train']['checkpoint_test'] == 0 and opt['rank'] == 0:
                ...
                for test_data in test_loader:
                    ...
                    visuals = model.current_visuals(need_HF=True)
                    ...
                    E_HB_save_img_path = os.path.join(
                    ...
                    avg_psnr_hf += current_psnr_hf

                avg_psnr = avg_psnr / idx
                avg_psnr_y = avg_psnr_y / idx
                avg_psnr_hf = avg_psnr_hf / idx

                # testing log
                logger.info('<epoch:{:3d}, iter:{:8,d}, Average PSNR : {:<.2f}dB, Average PSNR_Y : {:<.2f}dB, Average PSNR_HF : {:<.2f}dB\n'.format(
                    epoch, current_step, avg_psnr, avg_psnr_y, avg_psnr_hf))
